...
import { ArrowLeft, ArrowRight, Check, Truck, CreditCard, Banknote } from "lucide-react"
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-0.5">
                  <span className="font-medium text-foreground">Standard (3-5 days)</span>
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-0.5">
                  <span className="font-medium text-foreground">Express (1-2 days)</span>
                  <span className="text-sm text-muted-foreground">Priority handling and delivery</span>
                </div>
          ...
          >
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-0.5">
                  <span className="font-medium text-foreground">Card (simulated)</span>
                  <span className="text-sm text-muted-foreground">Pay securely with your credit or debit card</span>
                </div>
              </label>
              <label
                className={cn(
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-0.5">
                  <span className="font-medium text-foreground">Cash on delivery (simulated)</span>
...
export function CheckoutForm({
  ...
  const handleChange = (field: keyof CheckoutValues, value: string | boolean) => {
